...
r.nnoremap(']h', "&diff ? ']h' : '<cmd>lua require\"gitsigns\".next_hunk()<CR>'", 'git', 'git_next_hunk', 'Go to next hunk')
r.nnoremap('[h',  "&diff ? '[h' : '<cmd>lua require\"gitsigns\".prev_hunk()<CR>'", 'git', 'git_prev_hunk', 'Go to prev hunk')

r.nnoremap('<leader>hs', '<cmd>lua require"gitsigns".stage_hunk()<CR>', 'git', 'git_stage_hunk', 'Stage hunk')
r.nnoremap('<leader>hu', '<cmd>lua require"gitsigns".undo_stage_hunk()<CR>', 'git', 'git_undo_stage_hunk', 'Undo stage hunk')
