...
-- r.noremap("n", "<leader>dwh", dap_ui_widgets.hover, "dap", "Widgets hover")
-- r.noremap(
--   "n",
-- 	"<leader>dwf",
...
-- r.noremap("n", "<leader>dro", dap.repl.open, "Open REPL")
-- r.noremap("n", "<leader>drl", dap.repl.run_last, "REPL last")
