...
if (pcall(require, 'nvim-notify')) then telescope.load_extension('notify') end
...
nnoremap('<leader>mm', "<cmd>lua require('telescope.builtin').keymaps()<CR>", 'telescope', 'telescope_mappings', '');
...
nnoremap('<leader>/n', "<cmd>Telescope notify<CR>", 'telescope', 'telescope_notify', 'Search notifications')
